...
This is perfectly okay as long as the method remains [focused on one thing](/methods/method-body/do-one-thing-do-it-well-do-it-only/):
...
> The [section _Mind the performance_](/language/mind-the-performance/) gives guidance on how to balance Clean Code and performance.

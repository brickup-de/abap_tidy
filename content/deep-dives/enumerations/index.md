...
and came up with a set of [patterns](/deep-dives/enumerations/#patterns) that can be
...
They offer [compatibility](/deep-dives/enumerations/#compatibility) features to easily refactor legacy enumeration patterns.
When deciding against native enumerations or wanting to design one of your own, consider the [guidelines](/deep-dives/enumerations/#guidelines).
...
the **[constant pattern](/deep-dives/enumerations/#constant-pattern)**
or the **[object pattern](/deep-dives/enumerations/#object-pattern)**
because they combine most advantages
and can be generally considered clean.

The widely used [interface pattern](/deep-dives/enumerations/#interface-pattern)
is also acceptable, but has some slight drawbacks.

Think twice before resorting to the
[collection pattern](/deep-dives/enumerations/#collection-pattern).
...
If native enumeration cannot be used this is only achievable by the **[object pattern](/deep-dives/enumerations/#object-pattern)**:
```ABAP
METHODS log_contains
  IMPORTING

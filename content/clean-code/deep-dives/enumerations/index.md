...
They offer [compatibility](/clean-code/deep-dives/enumerations/#compatibility) features to easily refactor legacy enumeration patterns.
...
the **[constant pattern](/clean-code/deep-dives/enumerations/#constant-pattern)**
or the **[object pattern](/clean-code/deep-dives/enumerations/#object-pattern)**
because they combine most advantages
and can be generally considered clean.

The widely used [interface pattern](/clean-code/deep-dives/enumerations/#interface-pattern)
is also acceptable, but has some slight drawbacks.

Think twice before resorting to the
[collection pattern](/clean-code/deep-dives/enumerations/#collection-pattern).
...
If native enumeration cannot be used this is only achievable by the **[object pattern](/clean-code/deep-dives/enumerations/#object-pattern)**:
```ABAP
METHODS log_contains
  IMPORTING

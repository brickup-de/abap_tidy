...
read [Robert C. Martin's _Clean Code_](https://www.oreilly.com/library/view/clean-code/9780136083238/).
...
such as [Booleans](/clean-code/booleans/), [Conditions](/clean-code/conditions/), and [Ifs](/clean-code/ifs/).

You will probably benefit most from the section [Methods](/clean-code/methods/),
especially [Do one thing, do it well, do it only](/clean-code/methods/method-body/do-one-thing-do-it-well-do-it-only/) and [Small](/clean-code/methods/method-body/keep-methods-small/),
...
especially [Comments](/clean-code/comments/), [Names](/clean-code/names/), and [Formatting](/clean-code/formatting/)

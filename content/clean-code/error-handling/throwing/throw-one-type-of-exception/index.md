...
as described in [Use sub-classes to enable callers to distinguish error situations](/clean-code/error-handling/throwing/use-sub-classes-to-enable-callers-to-distinguish-error-situations/).
